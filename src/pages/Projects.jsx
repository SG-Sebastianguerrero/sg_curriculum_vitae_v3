      ...
      <div id="image-track" data-mouse-down-at="0" data-prev-percentage="0">
        <div className="image__content">
          <div className="image__description">
            <h2>Amazing Title</h2>
            <button className="image__viewmore">
              <svg
          ...
          <img
            className="image"
            draggable="false"
            src="https://images.unsplash.com/photo-1686153957738-fed649408234?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1181&q=80"
          />
        </div>
        <img
          className="image"
          draggable="false"
          src="https://images.unsplash.com/photo-1668778368277-75a432f832b0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=929&q=80"
        />
